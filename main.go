...
import (
	...
	"github.com/newlinedeveloper/odd-otel/tracing"
...
func connectMongo() {
	...
	docs := []interface{}{
		bson.D{{Key: "id", Value: "1"}, {Key: "title", Value: "CNCF session"}},
		bson.D{{Key: "id", Value: "2"}, {Key: "title", Value: "AWS session"}},
		bson.D{{Key: "id", Value: "3"}, {Key: "title", Value: "Azure session"}},
	}
